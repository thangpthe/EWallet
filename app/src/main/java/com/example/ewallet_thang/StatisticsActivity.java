...
public class StatisticsActivity extends AppCompatActivity {
    ...
    private void loadStatisticsData() {
        db.collection("transactions").whereEqualTo("userPhone", userPhone).get()
                .addOnSuccessListener(queryDocumentSnapshots -> {
                    ...
                    for (Map.Entry<String, Double> entry : expenseByCategory.entrySet()) {
                        ...
                        categoryStatList.add(new CategoryStat(entry.getKey(), entry.getValue(), percentage));
                    }
                    categoryStatAdapter.notifyDataSetChanged();
                });
    }
    ...
    private void setupBottomNav() {
        ...
        bottomNav.setOnItemSelectedListener(item -> {
            ...
            if (itemId == R.id.nav_home) {
                ...
                startActivity(new Intent(StatisticsActivity.this, NotificationActivity.class));
                return true;
            } else if (itemId == R.id.nav_statistics) {
                return true;
            } else if (itemId == R.id.nav_profile) {
